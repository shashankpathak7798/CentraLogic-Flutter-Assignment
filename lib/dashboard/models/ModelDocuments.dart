...
class Value {
  ...
  factory Value.fromJson(Map<String, dynamic> json) {
    ...
    List<Joining> tax = taxList.map((taxJson) => Joining.fromJson(taxJson)).toList();
...
/// Class to store all the decoded json data in a single object
class DocumentsData {
  ...
  static setDocumentsData({required List<Transaction> transactions, required List<Joining> team, required List<Joining> tax, required List<Joining> joining}) {
